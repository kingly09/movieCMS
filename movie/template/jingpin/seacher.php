...
?>
							...
							<div class="thumb">
							<a class="v-thumb stui-vodlist__thumb lazyload" href="<?php echo $chuandi?>" title="<?php echo $cs?>" <?php echo $ok;?> data-original="<?php echo $tupian?>"><span class="play hidden-xs"></span><span class="pic-text text-right"></span></a>
							</div>
							<div class="detail">
							<h3 class="title"><a href="<?php echo $chuandi?>" <?php echo $ok;?>><?php echo $cs?><?php echo $three[$ni]?></a></h3><br>
							<p class="margin-0 hidden-smss hidden-xss"><div class="m-description"><?php echo $jianjie?></div></p>
							<p class="margin-0 hidden-smss hidden-xss"><a <?php echo $ok;?> class="text-muted" href="<?php echo $chuandi?>" title="<?php echo $cs?>">查看详情</a></p>
							</div>
							</li>
...
<a class="v-thumb stui-vodlist__thumb lazyload" href="<?php echo $chuandi?>" title="<?php echo $title?>" <?php echo $ok;?> data-original="<?php echo $tupian?>">
...
<h4 class="title text-overflow"><a href="<?php echo $chuandi?>" <?php echo $ok;?> title="<?php echo $title?>"><?php echo $title?></a></h4>
<p class="text text-overflow text-muted hidden-xs">主演：<?php echo $q?></p>
</div>
</div>
</li>
<?php }echo '</ul><p style="text-align: center;height: 50px;background: #eee;line-height: 50px;font-size: 16px;cursor: pointer;"><a href="/mxstar_'.$q.'_dy_1.html" title="更多 '.$q.' 的影片">点击查看 '.$q.' 更多影片&gt;&gt;</a></p>';} else {echo '<p style="text-align: center;"><img class="sosoimg" src="/template/jingpin/img/blank.png" alt="暂无内容"/></p>';}?>
<div class="stui-pannel_hd">
			<div class="stui-pannel__head active bottom-line clearfix">
				<span class="more text-muted pull-right hidden-xs"></span>
